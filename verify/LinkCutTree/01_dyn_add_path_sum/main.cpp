...
int main() {
   ...
   auto g = [](ll a, ll b, int l) { return 0; };
   auto h = [](ll a, ll b) { return 0; };
   auto s = [](ll a) { return a; };

   LinkCutTree<ll> lct(f, g, h, s, 0, 0);

   rep(i, N) lct.MakeNode(al[i]);
