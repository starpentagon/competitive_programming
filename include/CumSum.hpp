...
// [Verified] N,Q <= 5*10^5, Static Range Sum, (https://judge.yosupo.jp/problem/static_range_sum)
// 累積和を求める
template <class T>
class CumSum {
  public:
...
// [Verified] RectSum H, W<=10^2: ARC_025「B - チョコレート」(https://atcoder.jp/contests/arc025/submissions/me)
// ToDo: 縦横斜め方向の累積和
